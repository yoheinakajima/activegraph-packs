"""Neutral semantic-attention evidence for later learned vectors.

This pack deliberately stops before choosing an importance/trust model. ADR
0028 leaves that representation to the vectors implementation round; the live
product first needs honest observations and exposure boundaries.
"""
